...
function FormLabel({ className, ...props }: React.ComponentProps<typeof LabelPrimitive.Root>) {
  ...
  return (
    <Label data-slot="form-label" className={cn(error && "text-critical", className)} htmlFor={formItemId} {...props} />
  );
}
...
function FormMessage({ className, ...props }: React.ComponentProps<"p">) {
  ...
  return (
    <p data-slot="form-message" id={formMessageId} className={cn("text-xs font-medium text-critical", className)} {...props}>
      {body}
    </p>
  );
}
